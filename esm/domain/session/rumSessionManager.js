...
import { startSessionManager } from './sessionManager';
export var RUM_SESSION_KEY = 'rum';
export function startRumSessionManager(configuration) {
    return __awaiter(this, void 0, void 0, function () {
        var sessionManager;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, startSessionManager(configuration.cookieOptions, RUM_SESSION_KEY, function (rawTrackingType) {

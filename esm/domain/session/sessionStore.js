    ...
    return __awaiter(this, void 0, void 0, function () {
        function expandOrRenewSession() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, newCookieOperations({
                                options: options,
        ...
        function retrieveActiveSession() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, retrieveSession()];
                        case 1:
                            session = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    watchSessionTimeoutId = setInterval(monitor(watchSession), COOKIE_ACCESS_DELAY);

...
exports.initConsoleObservable = exports.ConsoleApiName = void 0;
...
function buildConsoleLog(params, api, handlingStack) {
    ...
    if (api === exports.ConsoleApiName.error) {
        var firstErrorParam = (0, utils_1.find)(params, function (param) { return param instanceof Error; });
        log.stack = firstErrorParam ? (0, error_1.toStackTraceString)((0, tracekit_1.computeStackTrace)(firstErrorParam)) : undefined;

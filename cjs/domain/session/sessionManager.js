...
function startSessionManager(options, productKey, computeSessionState) {
    ...
    sessionStore.renewObservable.subscribe(function () {
        sessionContextHistory.setCurrent(buildSessionContext(), (0, timeUtils_1.relativeNow)());
    });
    sessionStore.expireObservable.subscribe(function () {
        sessionContextHistory.closeCurrent((0, timeUtils_1.relativeNow)());
    });
    sessionStore.expandOrRenewSession();
    sessionContextHistory.setCurrent(buildSessionContext(), (0, timeUtils_1.clocksOrigin)().relative);
...
function trackVisibility(expandSession) {
    var expandSessionWhenVisible = (0, internalMonitoring_1.monitor)(function () {

...
exports.relativeNow = exports.stopSessionManager = exports.startSessionManager = exports.VISIBILITY_CHECK_DELAY = void 0;
...
exports.VISIBILITY_CHECK_DELAY = 60 * 1000;
var SESSION_CONTEXT_TIMEOUT_DELAY = browser_core_1.SESSION_TIME_OUT_DELAY;
var stopCallbacks = [];
function startSessionManager(options, productKey, computeSessionState) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, sessionStore_1.startSessionStore)(options, productKey, computeSessionState)];
                case 1:
                    sessionStore = _a.sent();
                    stopCallbacks.push(function () { return sessionStore.stop(); });
                    sessionContextHistory = new browser_core_1.ContextHistory(SESSION_CONTEXT_TIMEOUT_DELAY);
...
function trackActivity(expandOrRenewSession) {
    electron_1.app.on('browser-window-created', expandOrRenewSession);
    electron_1.app.on('before-quit', stopSessionManager);
}
function trackVisibility(expandSession) {
    var expandSessionWhenVisible = (0, browser_core_1.monitor)(function () {
        if (electron_1.BrowserWindow.getAllWindows().find(function (w) { return w.isVisible(); })) {
            expandSession();
        }
    });
    electron_1.app.on('browser-window-focus', expandSessionWhenVisible);
    stopCallbacks.push(function () { return electron_1.app.removeListener('browser-window-focus', expandSessionWhenVisible); });

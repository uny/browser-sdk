...
exports.retrieveSession = exports.toSessionString = exports.persistSession = exports.newCookieOperations = exports.SESSION_COOKIE_NAME = void 0;
...
function newCookieOperations(operations) {
    var _a;
...
exports.newCookieOperations = newCookieOperations;
function next() {
    return __awaiter(this, void 0, void 0, function () {
        var nextOperations;
...
function persistSession(session, options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            session.expire = String(Date.now() + sessionStore_1.SESSION_EXPIRATION_DELAY);
...
function setSession(session, options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, (0, cookie_1.setCookie)(exports.SESSION_COOKIE_NAME, toSessionString(session), sessionStore_1.SESSION_EXPIRATION_DELAY, options)];
        });
    });
}
...
function retrieveSession() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, cookie_1.getCookie)(exports.SESSION_COOKIE_NAME)];
                case 1:
...
function clearSession(options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, (0, cookie_1.setCookie)(exports.SESSION_COOKIE_NAME, '', 0, options)];
        });
    });
}

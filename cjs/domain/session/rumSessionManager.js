...
exports.startRumSessionManager = exports.RUM_SESSION_KEY = void 0;
var browser_core_1 = require("@datadog/browser-core");
var sessionManager_1 = require("./sessionManager");
exports.RUM_SESSION_KEY = 'rum';
function startRumSessionManager(configuration) {
    return __awaiter(this, void 0, void 0, function () {
        var sessionManager;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, sessionManager_1.startSessionManager)(configuration.cookieOptions, exports.RUM_SESSION_KEY, function (rawTrackingType) {

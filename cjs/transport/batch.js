...
var Batch = /** @class */ (function () {
    ...
    Batch.prototype.flush = function (reason) {
        if (this.bufferMessageCount !== 0) {
            var messages = this.pushOnlyBuffer.concat((0, browser_core_1.objectValues)(this.upsertBuffer));
    ...
    Batch.prototype.addOrUpdate = function (message, key) {
        ...
        if (messageBytesSize >= this.maxMessageSize) {
            browser_core_1.display.warn("Discarded a message whose size was bigger than the maximum allowed size ".concat(this.maxMessageSize, "KB."));
            return;
        }
